...
export const exposureIndex = () =>
  number({ message: "Exposure index (EL)", default: 400 });

export const description = () => input({ message: "Description please" });

export const filmFormat = () =>
  number({ message: "Film format please", default: 135 });
...
export const developedAt = () =>
  select({
    message: "Developed at",
    choices: ["Lab", "Home"],
    default: "Home",
  });

export const notes = () => input({ message: "Notes", default: "-" });
