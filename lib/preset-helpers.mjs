import { promptSelect } from "./prompts.mjs";
import { chemicalPrompt, exhaustion, mixDate } from "./chem-prompts.mjs";

export const developmentProcess = () =>
  promptSelect("Development process", ["Standard", "Rotary", "Stand development"]);

export const filmProcessor = () =>
  promptSelect("Film processor", ["None", "AGO Film Processor"]);
